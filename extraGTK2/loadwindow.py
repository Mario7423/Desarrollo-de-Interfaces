...
class LoadWindow(Gtk.Window):
    label = Gtk.Label("Cargando xogo...") # Mensaxe de cargando mentras cargan os elementos
    spinner = Gtk.Spinner()
    ...
    def start_main_window(self, loaded_items_list):
        ...
        self.close()
    def load_json(self):
        response = requests.get("https://raw.githubusercontent.com/Mario7423/Desarrollo-de-Interfaces/main/extraGTK2/fallos.json") # Chamada do json e formado da lista
        json_list = response.json()

        result = []

        for json_item in json_list:
            name = json_item.get("fallos")
